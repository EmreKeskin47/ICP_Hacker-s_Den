...
fn main() {
    ...
    // Heap is used for storing objects and data structures that require a longer lifespan than stack memory
    ...
    functions::example_function(); // Calling the example_function
}
